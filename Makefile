...
docker-build:
	...
	@echo '__________________________________________________________'
	@chmod 777 logs/
	@docker network inspect deproject-network >/dev/null 2>&1 || docker network create deproject-network
	@echo '__________________________________________________________'
	@docker build -t deproject-dibimbing/spark -f ./FP-docker/Dockerfile.spark .
	@echo '__________________________________________________________'
	@docker build -t deproject-dibimbing/airflow -f ./FP-docker/Dockerfile.airflow .
	@echo '__________________________________________________________'
...
spark:
	...
	@echo '__________________________________________________________'
	@docker compose -f ./FP-docker/docker-compose-spark.yml --env-file .env up -d
	@echo '==========================================================='
...
airflow:
	...
	@echo '__________________________________________________________'
	@docker compose -f ./FP-docker/docker-compose-airflow.yml --env-file .env up
	@echo '==========================================================='

postgres: postgres-create postgres-create-warehouse postgres-create-table postgres-ingest-csv

postgres-create:
	@docker compose -f ./FP-docker/docker-compose-postgres.yml --env-file .env up -d
	@echo '__________________________________________________________'
